...
#linux based openslide tool & lib install

pip install wandb pandas  scikit-learn matplotlib==3.5.0 Pillow==9.4.0 scikit-image shapely==1.8.0 descartes==1.1.0 
...
python $SLIM_SCRIPTS/metrics_patchlevel.py $LOGDIR/all.txt > $LOGDIR/patch_level.xls
